...
<body>
    ...
    if(isset($_GET['file_name'])) 
    {
        ...
        // 查询数据库获取图片详情信息
        $sql = "SELECT * FROM captures WHERE file_name LIKE '%$file_name%'";
    ...
    <div class="box">
        <div>
            <h2><?php echo 'BOOK NAME: ' . $row["capture_name"] ?></h2><br>
...
//                    echo "<img src='" . $row["file_name"] . "' alt='" . $row["book_name"] . "'>";
                    echo "<a href='detail.php?file_name=" . $row["file_name"] . "'>" . $row["capture_name"] . '</a>';
                } else {
